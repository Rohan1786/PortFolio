...
const AboutMeSection = () => {
  ...
  return (
    <div>
      <section className="bg-purple-500 text-white py-16 font-Qwitcher">
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-6">
          ...
          <div className="w-full lg:w-1/3 flex justify-center mb-8 lg:mb-0">
            <img
              ...
              alt="Profile"
              className="rounded-full border-4 border-gray-500 shadow-lg h-40 w-40 object-cover transform hover:scale-110 transition duration-500 ease-in-out"
            />
          </div>

          {/* Description */}
          <div className="w-full lg:w-2/3">
            <h2 className="text-6xl font-semibold mb-4">{textArray[0]}</h2>
            <div
              className={`text-4xl mb-4 leading-relaxed text-container transition-opacity duration-500 ease-in-out`}
